...
/									Drizzy - Drizzy#2647
/								
/										Sabong Script from Drizzy Itself
/

...
// Modular Callback - GENJI
public OnGameModeInit()
{
    print("Betting System");
    SetTimer("BettingTimer", 1000, true);
    CreatePlayerBoxingCage();
    #if defined SABONG_OnGameModeInit
        return SABONG_OnGameModeInit();
    #else
        return 1;
    #endif
}
...
#endif
#define OnGameModeInit SABONG_OnGameModeInit
#if defined SABONG_OnGameModeInit
    forward SABONG_OnGameModeInit();
#endif
...
public OnPlayerConnect(playerid){
    ...
    #if defined SABONG_OnPlayerConnect
        return SABONG_OnPlayerConnect(playerid);
    #else
        return 1;
    #endif
}
...
#endif
#define OnPlayerConnect SABONG_OnPlayerConnect
#if defined SABONG_OnPlayerConnect
	forward SABONG_OnPlayerConnect(playerid);
#endif
...
public OnPlayerClickPlayerTextDraw(playerid, PlayerText:playertextid){
    ...
    #if defined SS_OnPlayerClickPlayerTextDraw
        return SS_OnPlayerClickPlayerTextDraw(playerid, PlayerText:playertextid);
    #else
        return 1;
    #endif
}
...
public OnPlayerDeath(playerid, killerid, reason){
    ...
    #if defined SABONG_OnPlayerDeath
...
#endif
#define OnPlayerDeath SABONG_OnPlayerDeath
#if defined SABONG_OnPlayerDeath
